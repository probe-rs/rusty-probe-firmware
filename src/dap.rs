...
impl swo::Swo for Swo {
    fn set_transport(&mut self, _transport: swo::SwoTransport) -> bool {
        false
    }

    fn set_mode(&mut self, _mode: swo::SwoMode) -> bool {
        false
    }
    ...
    fn set_control(&mut self, _control: swo::SwoControl) -> bool {
        false
    }
...
pub fn create_dap(
    ...
    dap::Dap::new(context, leds, wait, swo, version_string, 512)
}
